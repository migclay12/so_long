...
int prtimage()
{
	...
	image . img =  mlx_new_image ( vars . mlx , img_width , img_height ) ;  // create image object 
	image . addr =  mlx_get_data_addr ( image . img ,  & image . bits_per_pixel ,  & image . line_length ,  & image . endian ) ;  // assign image address 
